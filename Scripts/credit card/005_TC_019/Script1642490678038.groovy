...
WebUI.click(findTestObject('Page_Axis Bank/a_Yes'))
...
WebUI.setText(findTestObject('Object Repository/Page_Axis Bank/input_PAN_cust_PAN'), 'XXXXX0000Z')

WebUI.click(findTestObject('Object Repository/Page_Axis Bank/button_Next'))

WebUI.verifyTextPresent('Invalid Pan', false)
